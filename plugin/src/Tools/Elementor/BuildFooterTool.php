...
/**
 * Tool: wordpress.elementor.footer.build
 *
 ...
 * @since   0.1.0
 */
final class BuildFooterTool extends AbstractTool
{
    ...
    {
        return 'wordpress.elementor.footer.build';
    }

    public function getDescription(): string
    {
        return 'Creates a new Footer template inside the Elementor Library.';
    }
    ...
    public function getInputSchema(): array
    {
        return [
            ...
            'properties' => [
                'title'  => [
                    'type'        => 'string',
                    'description' => 'The title of the footer template (e.g. "Main Footer").',
                    'minLength'   => 1,
                ],
                'layout' => [
                    'type'        => 'array',
    ...
    protected function handle(array $args, Identity $identity): ToolResult
    {
        ...
        update_post_meta($templateId, '_elementor_template_type', 'footer');

        return ToolResult::json([
            'success'     => true,
            'template_id' => $templateId,
            'title'       => $title,
            'message'     => 'Elementor Footer template successfully created.',
        ]);
    }
}
